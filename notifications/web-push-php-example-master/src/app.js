document.addEventListener("DOMContentLoaded", () => {
    const applicationServerKey = "BPIKimNFUomQVXzOr5Zc09uzcijMV2-5j5T2GxnEUSyhePuOiPRAd45gc-c0mW0TQ51ZFi5e3Adum3qxJivc9xM";
    ...
    function push_subscribe() {
        ...
        .catch(e => {
            if (Notification.permission === 'denied') {
                ...
                console.error('Impossible to subscribe to push notifications [common reasons include network errors or the user skipped the permission]', e);
