...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link href="hs/css.css" rel="stylesheet" type="text/css">
    <link href="hs/toolkit.css" rel="stylesheet">
    
    <link href="hs/application.css" rel="stylesheet">
...
<nav class="ck pt adq py tk app-navbar">
  ...
  <a class="e" href="index.html">
    <img src="hs/brand-white.png" alt="brand">
  </a>
  ...
  <div class="collapse f" id="navbarResponsive">
    <ul class="navbar-nav ahq">
      <li class="pi active">
        <a class="pg" href="https://bootstrap-themes.github.io/application/index.html">Home <span class="adt">(current)</span></a>
      </li>
      <li class="pi">
        <a class="pg" href="https://bootstrap-themes.github.io/application/profile/index.html">Profile</a>
      </li>
      <li class="pi">
        <a class="pg" data-toggle="modal" href="#msgModal">Messages</a>
      </li>
      <li class="pi">
        <a class="pg" href="https://bootstrap-themes.github.io/application/docs/index.html">Docs</a>
      </li>

      <li class="pi vm">
        <a class="pg" href="https://bootstrap-themes.github.io/application/notifications/index.html">Notifications</a>
      </li>
      <li class="pi vm">
        <a class="pg" data-action="growl">Growl</a>
      </li>
      <li class="pi vm">
        <a class="pg" href="phps/logout.php">Logout</a>
      </li>

    </ul>

    <form class="nn acx d-none vt">
      <input class="form-control" data-action="grow" placeholder="Search" type="text">
    </form>

    <ul id="#js-popoverContent" class="nav navbar-nav acx aek d-none vt">
      <li class="pi">
        <a class="g pg" href="https://bootstrap-themes.github.io/application/notifications/index.html">
          <span class="h azy"></span>
        </a>
      </li>
      <li class="pi afb">
        <button class="cg bpo bpp boi" data-toggle="popover" data-original-title="" title="">
          <img class="us" src="hs/avatar-dhg.png">
        </button>
      </li>
    </ul>
    ...
    <ul class="nav navbar-nav d-none" id="js-popoverContent">
      ...
      <li class="pi"><a class="pg" href="phps/logout.php">Logout</a></li>
    </ul>
  </div>
</nav>
      ...
      <div class="modal-body afx js-modalBody">
        <div class="axw">
          <div class="bow cj ca js-msgGroup">
            <a href="#" class="b rx">
              <div class="rv">
                <img class="us bos vb yb aff" src="hs/avatar-fat.jpg">
                <div class="rw">
            ...
            <a href="#" class="b rx">
              <div class="rv">
                <img class="us bos vb yb aff" src="hs/avatar-mdo.png">
                <div class="rw">
            ...
            <a href="#" class="b rx">
              <div class="rv">
                <img class="us bos vb yb aff" src="hs/avatar-dhg.png">
                <div class="rw">
...
leo risus, porta ac consectetur ac, vestibulum at eros. Sed posuere 
consectetur est at lobortis.
                ...
                <img class="us bos vb yb afi" src="hs/avatar-dhg.png">
              </li>
...
ligula, eget lacinia odio sem nec elit. Praesent commodo cursus magna, 
...
ornare vel eu leo. Morbi leo risus, porta ac consectetur ac, vestibulum 
at eros.
                  </div>
                  <div class="bpd">
                   Cras mattis consectetur purus sit amet fermentum. 
Donec sed odio dui. Integer posuere erat a ante venenatis dapibus 
posuere velit aliquet. Nulla vitae elit libero, a pharetra augue. Donec 
...
vestibulum at eros. Aenean lacinia bibendum nulla sed consectetur.
                  ...
                  <div class="bpd">
                   Curabitur blandit tempus porttitor. Integer posuere 
      ...
      <div class="modal-body afx">
        <div class="axw">
          <ul class="bow cj ca">
            <li class="b">
              <div class="rv ady">
                <img class="bos vb yb aff" src="hs/avatar-fat.jpg">
                <div class="rw">
            ...
            <li class="b">
              <div class="rv ady">
                <img class="bos vb yb aff" src="hs/avatar-dhg.png">
                <div class="rw">
                  <button class="cg ns ok acx">
                    <span class="c bps"></span> Follow
                  </button>
            ...
            <li class="b">
              <div class="rv ady">
                <img class="bos vb yb aff" src="hs/avatar-mdo.png">
                <div class="rw">
                  <button class="cg ns ok acx">
                    <span class="c bps"></span> Follow
                  </button>
      ...
      <div class="pz bpi afo">
        ...
        <div class="qa avz">
          <a href="https://bootstrap-themes.github.io/application/profile/index.html">
            <img class="bpj" src="hs/avatar-dhg.png">
          </a>
      ...
      <div class="pz vp vy afo">
        <div class="qa">
          ...
          <ul class="dc axg">
            ...
            </li><li><span class="axc h bnc aff"></span>Became friends with <a href="#">Obama</a>
            </li><li><span class="axc h bfa aff"></span>Worked at <a href="#">Github</a>
            </li><li><span class="axc h bfq aff"></span>Lives in <a href="#">San Francisco, CA</a>
            </li><li><span class="axc h bgz aff"></span>From <a href="#">Seattle, WA</a>
          </li></ul>
        </div>
      </div>
       ...
       <div class="pz vp vy afo">
        <div class="qa">
          ...
          <div data-grid="images" data-target-height="150"><div style="margin-bottom: 10px; margin-right: 10px; display: inline-block; vertical-align: bottom;">
              <img data-width="640" data-height="640" data-action="zoom" src="hs/instagram_5.jpg" style="width: 114px; height: 115px;">
            </div><div style="margin-bottom: 10px; margin-right: 0px; display: inline-block; vertical-align: bottom;">
              <img data-width="640" data-height="640" data-action="zoom" src="hs/instagram_6.jpg" style="width: 115px; height: 115px;">
            </div><div style="margin-bottom: 10px; margin-right: 10px; display: inline-block; vertical-align: bottom;">
              <img data-width="640" data-height="640" data-action="zoom" src="hs/instagram_7.jpg" style="width: 114px; height: 115px;">
            </div><div style="margin-bottom: 10px; margin-right: 0px; display: inline-block; vertical-align: bottom;">
              <img data-width="640" data-height="640" data-action="zoom" src="hs/instagram_8.jpg" style="width: 115px; height: 115px;">
            </div><div style="margin-bottom: 10px; margin-right: 10px; display: inline-block; vertical-align: bottom;">
              <img data-width="640" data-height="640" data-action="zoom" src="hs/instagram_9.jpg" style="width: 114px; height: 115px;">
            </div><div style="margin-bottom: 10px; margin-right: 0px; display: inline-block; vertical-align: bottom;">
              <img data-width="640" data-height="640" data-action="zoom" src="hs/instagram_10.jpg" style="width: 115px; height: 115px;">
            </div></div>
        </div>
      </div>
    </div>
...
montes, nascetur ridiculus mus.
            ...
            <div class="boy" data-grid="images"><div style="display: inline-block; margin-bottom: 10px; margin-right: 10px; vertical-align: bottom;">
                <img data-action="zoom" data-width="1050" data-height="700" src="hs/unsplash_1.jpg" style="width: 273px; height: 182px;">
              </div><div style="display: inline-block; margin-bottom: 10px; margin-right: 0px; vertical-align: bottom;">
                <img data-action="zoom" data-width="640" data-height="640" src="hs/instagram_1.jpg" style="width: 182px; height: 182px;">
              </div><div style="display: inline-block; margin-bottom: 10px; margin-right: 10px; vertical-align: bottom;">
                <img data-action="zoom" data-width="640" data-height="640" src="hs/instagram_13.jpg" style="width: 181px; height: 182px;">
              </div><div style="display: inline-block; margin-bottom: 10px; margin-right: 0px; vertical-align: bottom;">
                <img data-action="zoom" data-width="1048" data-height="700" src="hs/unsplash_2.jpg" style="width: 274px; height: 182px;">
              </div></div>
...
ridiculus mus. Morbi leo risus, porta ac consectetur ac, vestibulum at 
...
sem malesuada magna mollis euismod. Donec sed odio dui.
            ...
            <div class="boy" data-grid="images"><img style="display: inline-block; width: 466px; height: 451px; margin-bottom: 10px; margin-right: 0px; vertical-align: bottom;" data-width="640" data-height="640" data-action="zoom" src="hs/instagram_3.jpg"></div>
...
consectetur est at lobortis.
    ...
    <div class="fj">
      ...
      <div class="pz afo d-none vy">
        <div class="qa">
          ...
          <div data-grid="images" data-target-height="150"><img class="bos" data-width="640" data-height="640" data-action="zoom" src="hs/instagram_2.jpg" style="width: 240px; height: 225px; margin-bottom: 10px; margin-right: 0px; display: inline-block; vertical-align: bottom;"></div>
    ...
    <script src="hs/jquery.js"></script>
    <script src="hs/popper.js"></script>
    <script src="hs/chart.js"></script>
    <script src="hs/toolkit.js"></script>
    <script src="hs/application.js"></script>
    <script>
