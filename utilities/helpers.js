// TODO: rename this file Appropriately ...from helpers.js to sth better
 ...
 */
exports.sendSignupWelcomeEmail = async function (email, name, state) {
    
    // for now, only send email in production
    ...
    if (process.env.NODE_ENV && process.env.NODE_ENV === 'production') {
        ...
        let info = await transporter.sendMail({
          ...
          text: `A short introduction! ${name}, we're glad you're now online with us. We are psyched about it. 
